...
void genCode(ASTNode* tree, int count, FILE *out);
...
// AST_RELEXPR  - relational expression; child[0] is left side, ival is used
//                for storing relop; child[1] is right side
